...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-136697480-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-136697480-1');
</script>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Total IT Nigeria Ltd. - The complete ICT solution place| Store</title>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-53952576-1"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-53952576-1');
        </script>
    </head>
  ...
  <!-- Google Analytics -->
    ...
    <nav class="navbar navbar-default navbar-fixed-top mega navbar-inverse navbar-trans navbar-fw ">
        ...
        <div id="navbar" class="navbar-collapse collapse page-scroll navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="store.html">Store
                        <span class="{{url('/category/3')}}"></span>
                    </a>
                </li>
                <li>
    ...
    <!-- / .navbar -->
        ...
        <header class="page-title pt-large pt-dark pt-plax-lg-dark" data-stellar-background-ratio="0.4" style="background-position: 0px 1007.4px;">
          <div class="container">
              <div class="row">

                <div class="col-sm-6">
                  <h1>Store</h1>
                  <span class="subheading"><strong>All Laptops are UK USED except otherwise stated in product description & all prices are subject to change due to dollar fluctuation</strong> </span>
                </div>
  ...
  <div class="row ws-m">
     <div class="col-md-12">
        <ul class="product-meta">
           <!--li>SKU: 5471</li-->
           <li>CATEGORY: <a href="#laptopaccessories">{{ $shirt->category->name}}</a></li>
           <li>TAGS: <a href="#">{{ $shirt->category->name}}</a>, <a href="#"></a></li>
        </ul>
     </div>
     <!-- Prodcut Images -->
     <div class="col-md-1">
        <ul class="prod_single_thumbs_slider">
           <li><img src="assets/images/slider-thumb-5a.jpg" alt="Product Thumb"></li>
           <li><img src="assets/images/slider-thumb-5b.jpg" alt="Product Thumb"></li>
           <li><img src="assets/images/slider-thumb-5c.jpg" alt="Product Thumb"></li>
        </ul>
     </div>
     <div class="col-md-5">
        <ul class="prod_single_img_slider slick-initialized slick-slider">
           <div aria-live="polite" class="slick-list draggable" style="height: 570px;">
              <div class="slick-track" style="opacity: 1; width: 2285px; transform: translate3d(-914px, 0px, 0px);">
                 <li class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 457px;"><img class="img-responsive" src="assets/images/shop-img-big-5.jpg" alt="Product Image"></li>
                 <li class="slick-slide" data-slick-index="0" aria-hidden="true" style="width: 457px;"><img class="img-responsive" src="assets/images/shop-img-big-5.jpg" alt="Product Image"></li>
                 <li class="slick-slide slick-active" data-slick-index="1" aria-hidden="false" style="width: 457px;"><img class="img-responsive" src="{{url('images',$shirt->image)}}" alt="Product Image"></li>
                 <li class="slick-slide" data-slick-index="2" aria-hidden="true" style="width: 457px;"><img class="img-responsive" src="assets/images/shop-img-big-5.jpg" alt="Product Image"></li>
                 <li class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" style="width: 457px;"><img class="img-responsive" src="assets/images/shop-img-big-5.jpg" alt="Product Image"></li>
              </div>
           </div>
           <button type="button" class="shop-p-slider-nav shop-p-slider-nav-left" style="display: block;">
             <span class="linea-arrows-slim-left"></span>
            </button>
            <button type="button" class="shop-p-slider-nav shop-p-slider-nav-right" style="display: block;">
              <span class="linea-arrows-slim-right"></span>
            </button>
           <ul class="slick-dots" style="display: block;">
              <li class="" aria-hidden="true"><a href="#"><img class="prothumb" src="{{url('images',$shirt->image)}}" alt="Product Thumb"></a></li>
              <li aria-hidden="false" class="slick-active"><a href="#"><img class="prothumb" src="{{url('images',$shirt->image)}}" alt="Product Thumb"></a></li>
              <li aria-hidden="true" class=""><a href="#"><img class="prothumb" src="{{url('images',$shirt->image)}}" alt="Product Thumb"></a></li>
           </ul>
        </ul>
     </div>
     <!-- / .col-md-6 -->
     ...
     <div class="col-md-5 product-info">
        <span class="prod-cat">{{ $shirt->category->name}}</span>
        <h1 class="prod-name">{{$shirt->name}}</h1>
        <h3 class="prod-price">₦{{$shirt->price}} </h3>
        <p class="prod-desc">{{$shirt->description}}</p>
        <!--ul class="prod-rating">
           <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#"><i class="fa fa-star"></i></a></li>
           <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#"><i class="fa fa-star"></i></a></li>
           <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#"><i class="fa fa-star"></i></a></li>
           <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#"><i class="fa fa-star"></i></a></li>
           <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#"><i class="fa fa-star-o"></i></a></li>
           <li>14 Reviews</li>
        </ul>
        <div class="prod-size">
           <h5>UK Size</h5>
           <ul class="sizes">
              <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#">S</a></li>
              <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#" class="size-btn-active">M</a></li>
              <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#">L</a></li>
              <li><a href="http://themes.89elements.com/definity-html/{{route('cart.index')}}#">XL</a></li>
           </ul>
        </div-->
        <button href="{{route('cart.addItem',$shirt->id)}}" onclick="doSomething({{$shirt->id}})" class="btn btn-large">Add to Cart</button>
     </div>
     <!-- / .col-md-5 -->
  </div>
  <!-- / .row -->
...
<!-- / .container -->
              ...
              <div class="col-xs-12 col-sm-6 col-lg-3 ">
                <div class="shop-product-card">
                  ...
                  <div class="product-meta">
                    ...
                    <button href="{{route('cart.addItem',$products[2]->id)}}" onclick="doSomething({{$products[2]->id}})" class="btn-ghost btn-small btn-round">Add To Cart</button>
                  </div>
               ...
               <div class="col-xs-12 col-sm-6 col-lg-3 ">
                <div class="shop-product-card">
                  ...
                  <div class="product-meta">
                    ...
                    <button href="{{route('cart.addItem',$products[3]->id)}}" onclick="doSomething({{$products[3]->id}})" class="btn-ghost btn-small btn-round">Add To Cart</button>
                  </div>
              ...
              <div class="col-xs-12 col-sm-6 col-lg-3 ">
                  <div class="shop-product-card">
                    ...
                    <div class="product-meta">
                      ...
                      <button href="{{route('cart.addItem',$products[4]->id)}}" onclick="doSomething({{$products[4]->id}})" class="btn-ghost btn-small btn-round">Add To Cart</button>
                    </div>
              ...
              <div class="col-xs-12 col-sm-6 col-lg-3 ">
                  <div class="shop-product-card">
                    ...
                    <div class="product-meta">
                      ...
                      <button href="{{route('cart.addItem',$products[5]->id)}}" onclick="doSomething({{$products[5]->id}})" class="btn-ghost btn-small btn-round">Add To Cart</button>
                    </div>
       ...
       <aside class="container shop-sidebar">
        <div class="row ws-m">

          <!-- Cart Widget -->
          <div class="col-md-3 shop-widget cart-widget mb-sm-50">
            <h5 class="header-widget">Top Brands</h5>
            <div class="cart-item">
              <a href="#"><img src="{{asset('assets/images/brand1.jpg')}}" alt="Product Name" class="p-thumb"></a>
              <!--a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"> </span></a-->
              <a href="#" class="cp-name">HP</a>
              <p class="cp-price"></p>
            </div>
            ...
            <div class="cart-item">
              <a href="#"><img src="{{asset('assets/images/brand2.jpg')}}" alt="Product Name" class="p-thumb"></a>
              <!--a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"> </span></a-->
              <a href="#" class="cp-name">DELL</a>
              <p class="cp-price"></p>
            </div>
            ...
            <div class="cart-item">
              <a href="#"><img src="{{asset('assets/images/brand3.jpg')}}" alt="Product Name" class="p-thumb"></a>
              <!--a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"> </span></a-->
              <a href="#" class="cp-name">Toshiba</a>
              <p class="cp-price"></p>
            </div>
            ...
            <div class="cart-item">
              <a href="#"><img src="{{asset('assets/images/brand4.jpg')}}" alt="Product Name" class="p-thumb"></a>
              <!--a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"> </span></a-->
              <a href="#" class="cp-name">Apple</a>
              <p class="cp-price"></p>
            </div>
            ...
            <div class="cart-item">
              <a href="#"><img src="{{asset('assets/images/brand5.jpg')}}" alt="Product Name" class="p-thumb"></a>
              <!--a href="#" class="cart-remove-btn"><span class="linea-arrows-square-remove"> </span></a-->
              <a href="#" class="cp-name">Lenovo</a>
              <p class="cp-price"></p>
            </div>

            <!--div class="cw-subtotal pull-right">
              <h6 class="h-alt">SUBTOTAL: ₦718.98</h6>
              <a href="shop-checkout.html" class="btn-ghost btn-small">View Cart</a>
            </div-->
          </div><!-- / .cart-widget -->


          
          <div class="col-md-3 shop-widget mb-sm-50">
            <!-- Price Filter >
            <div class="filter-widget mb-50">
              <h5 class="header-widget">Filter by Price</h5>
              <div id="shop-slider-range" class="ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"><div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 3.23077%; width: 92.3077%;"></div><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 3.23077%;"></span><span tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default" style="left: 95.5385%;"></span></div>
              <p>
           ...
           <div class="categories-widget">
              ...
              <div class="widget-item">
                <a href="{{url('/category/3')}}">Laptops - <span></span></a>
              </div>
              <!-- Item 2 -->
              <div class="widget-item">
                <a href="{{url('/category/5')}}">Phones - <span></span></a>
              </div>
              <!-- Item 3 -->
              <div class="widget-item">
                <a href="{{url('/category/4')}}">Phone Accessories - <span></span></a>
              </div>
              <!-- Item 4 -->
              <div class="widget-item">
                <a href="{{url('/category/4')}}">Laptop Accessories - <span></span></a>
              </div>
          ...
          <!-- Product Widget -->
          <div class="col-md-3 shop-widget product-widget mb-sm-50">
            <h5 class="header-widget">Bestsellers</h5>
            <div class="cart-item">
                <a href="{{route('shirt',$products[5]->id)}}"><img class="cartthumb" src="{{url('images',$products[5]->image)}}" alt="Product Name" class="p-thumb"></a>
                <a href="{{route('shirt',$products[5]->id)}}" class="cp-name">{{$products[5]->name}}</a>
                <p class="cp-price"><span class="price-cut">₦{{($products[5]->price+10000)}}</span> ₦{{$products[5]->price}}</p>
              </div>
  
              <div class="cart-item">
                <a href="{{route('shirt',$products[6]->id)}}"><img class="cartthumb" src="{{url('images',$products[6]->image)}}" alt="Product Name" class="p-thumb"></a>
                <a href="{{route('shirt',$products[6]->id)}}" class="cp-name">{{$products[6]->name}}</a>
                <p class="cp-price">₦{{$products[6]->price}}</p>
              </div>
  
              <div class="cart-item">
                <a href="{{route('shirt',$products[7]->id)}}"><img class="cartthumb" src="{{url('images',$products[7]->image)}}" alt="Product Name" class="p-thumb"></a>
                <a href="{{route('shirt',$products[7]->id)}}" class="cp-name">{{$products[7]->name}}</a>
                <p class="cp-price">₦{{$products[7]->price}}</p>
              </div>
  
              <div class="cart-item">
                <a href="{{route('shirt',$products[8]->id)}}"><img class="cartthumb" src="{{url('images',$products[8]->image)}}" alt="Product Name" class="p-thumb"></a>
                <a href="{{route('shirt',$products[8]->id)}}" class="cp-name">{{$products[8]->name}}</a>
                <p class="cp-price">₦{{$products[8]->price}}</p>
              </div>
          </div><!-- / .cart-widget -->
