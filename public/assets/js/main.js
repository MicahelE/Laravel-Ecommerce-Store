(function ($) {
	...
	function initKenburns() {
		...
		if (hasKenburns) {
			...
			$('.kenburns').kenburns({
				images: ['assets/images/hero/TIT WEB-16.jpg',
				'assets/images/hero/TIT WEB-17.jpg',
				'assets/images/hero/TIT WEB-18.jpg',
				'assets/images/hero/TIT WEB-19.jpg',
					'assets/images/hero/kb-slide-2.jpg',
					'assets/images/hero/kb-slide-3.jpg',
					'assets/images/hero/kb-slide-4.jpg',
					'assets/images/hero/kb-slide-5.jpg',
					'assets/images/hero/kb-slide-6.jpg',
					'assets/images/hero/kb-slide-7.jpg'
				],
	...
	function initCountdown() {
		...
		if (hasCountdown) {
			...
			$('#cs-timer').countdown('2018/04/06', function (event) {
